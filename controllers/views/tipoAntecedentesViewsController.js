...
exports.getListar = async (req, res, next) => {
    try {
        ...
        const { count, rows: tiposAntecedentes } = await TiposAtencedentes.findAndCountAll({
            where: whereClause,
            order: [['nombre', 'ASC']],
        ...
        res.render('./Antecedente/TiposAntecedentes.pug', {
            title: 'Listado de Tipos de Antecedentes',
